...
def sane_custom_obname(ob):
    if ob.data:
        return ob.data.name + "&&&" + sane_name(ob, sane_name_mapping_ob, sane_name_mapping_ob_unique)
    else:
        return sane_name(ob, sane_name_mapping_ob, sane_name_mapping_ob_unique)
...
def save_single(operator, scene, filepath="",
    ...
    class my_object_generic(object):
        ...
        def __init__(self, ob, matrixWorld=None):
            self.fbxName = sane_custom_obname(ob)
            self.blenObject = ob
            self.fbxGroupNames = []
