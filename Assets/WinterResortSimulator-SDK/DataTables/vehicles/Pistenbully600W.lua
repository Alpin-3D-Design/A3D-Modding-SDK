...
ModLoader.addContent("vehicle", {
	...
	title					= "$shop_pistenbully600_winch_title",
	fullDesc				= "$shop_pistenbully600_winch_desc",
	techSpecs				= "$shop_pistenbully600_winch_specs",
	previewFilename			= "$vehicles/pistenbully/pistenbully600W",
	...
	class					= Vehicle,
	prefab					= "$vehicles/pistenbully600W",
	vehicleScripts			= {
		Seats,
		TrackedVehicle,
		VehicleLighting,
