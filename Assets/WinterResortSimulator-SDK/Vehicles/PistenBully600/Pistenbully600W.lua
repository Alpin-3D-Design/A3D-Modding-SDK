...
ModLoader.addContent("vehicle", {
	contentName				= "pistenbully600W",
	title					= "Pistenbully 600 W",
	fullDesc				= "In contrast to the solo-Version, this machine is equipped with a powerful 4.6 to winch which allows it to climb up even steepest slopes easily.",
	techSpecs				= "Engine power:\t\t461 HP\nBlade:\t\t\t12-way blade 4.4 m\nGroomer:\t\t\tAlpinFlexFräse Comfort 5.5 m",
	previewFilename			= "PB600WLogo",
	logoFilename			= "PistenBullyLogo",
	...
	motorMinRpm				= 900,
	motorMaxRpm				= 2000,
	hydraulicMaxSpeed		= 24,
	--controlIntegrationTime	= 0.005,
		...
		customLights		= {
			{
				...
				indexes			= {
					...
					"Winch/Winch_Seitenarbeitslicht_an",
				...
				indexesInverse	= { 
					...
					"Winch/Winch_Seitenarbeitslicht_aus",
			},
			...
			},
			{
				-- Worklight 3
				indexes			=	{
					"Winch/Winch_Winch_Ruecklicht_an",
					"Winch/Winch_Trommel_colcon/Winch_Neigung/Winch_Arm_colcon/Winch_Armlicht_an",
					"PB600_Lights/PB600_Suchscheinwerfer/PB600_Suchscheinwerfer_Licht_an",
				},
				indexesInverse	= {
					"Winch/Winch_Winch_Ruecklicht_aus",
					"Winch/Winch_Trommel_colcon/Winch_Neigung/Winch_Arm_colcon/Winch_Armlicht_aus",
	...
	ropeWinch				= {
		winchRoot			= "Winch/Winch_Trommel_colcon",
		winchIntake			= "Winch/Winch_Trommel_colcon/Winch_Neigung/Winch_Arm_colcon/Winch_Einlauf_LOD0",
		connector			= "Winch/Winch_Trommel_colcon/Winch_Neigung/Winch_Arm_colcon/ControlElement",
		ropeDiameter		= 0.011,
		weightPerMeter		= 45,
		ropeWinchForceMin	= 600,
		ropeWinchForceMax	= 46000,
		forceToggleDuration	= 1.5,

		-- hook
		detachedHookIndex		= "Winch/Winch_Trommel_colcon/Winch_Neigung/Winch_Arm_colcon/Winch_detached",
		intakeDefaultRotation	= -15.723,
		attachedHookIndex		= "Winch/Haken_attached",
		attachedHookTargetIndex	= "Winch/Haken_attached/Target",


		-- solo, i.e. without using the winch
		soloForwardStiffness	= 1.0,
		soloSidewaysStiffness	= 1.0,

		-- with winch in use
		maxForwardStiffness		= 1.7,
		maxSidewaysStiffness	= 1.7,
	},
	anchorPoints			= {
		{
