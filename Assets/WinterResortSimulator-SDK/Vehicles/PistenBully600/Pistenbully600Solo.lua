...
ModLoader.addContent("vehicle", {
	...
	title					= "Pistenbully 600",
	fullDesc				= "The snowcat 600 LEVEL RED convinces with numerous patents, maximum economy and the quietest and cleanest engine in its class.",
	techSpecs				= "Engine power:\t\t461 HP\nBlade:\t\t\t12-way blade 4.4 m\nGroomer:\t\t\tAlpinFlexFräse Comfort 5.5 m",
	previewFilename			= "PB600SoloLogo",
