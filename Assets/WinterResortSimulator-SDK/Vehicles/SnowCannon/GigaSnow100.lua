...
ModLoader.addContent("vehicle", {
	...
	title					= "Marmotta GigaSnow 100",
	fullDesc				= "The GigaSnow 100 combines the highest snowmaking performance and optimum throwing distance with unbeatable economy.",
	techSpecs				= "Transportation:\t\tat Pistenbully 600 blade\nOperation:\t\t\ton site or via remote control",
	previewFilename			= "GigaSnow100Logo",
